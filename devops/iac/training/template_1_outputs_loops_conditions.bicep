...
@batchSize(1)
resource rDFStorageAccounts 'Microsoft.Storage/storageAccounts@2021-06-01' = [ for storageAccountName in v_storageAccountNames : if (p_deployFlag) {

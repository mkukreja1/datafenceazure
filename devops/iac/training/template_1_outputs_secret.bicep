...
param p_containerName string = 'dfcontainer'

@description('Secret Tag')
@secure()
param p_secretTag string
...
resource container 'Microsoft.Storage/storageAccounts/blobServices/containers@2019-06-01' = {
  name: '${rDFStorageAccount.name}/default/${p_containerName}'
}


output storageAccountEndpointBlob string = rDFStorageAccount.properties.primaryEndpoints.blob
output storageAccountId string = rDFStorageAccount.id
